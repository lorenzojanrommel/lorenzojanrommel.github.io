...
<div class="form-container">
	<h4 class="center">Register Admin in Bacabac Farmers Producer Cooperative</h4>
...
<form method="POST" action="add_admin.php">
	...
	<div class="input-field col s12">
	<input type="submit" name="register_admin" id="submit" class="btn green accent-2 validate" value="Register" disabled>
	</div>
	</div>
</form>
</div>
